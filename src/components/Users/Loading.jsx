    ...
    return (
        <div className={classes.loaderPanel}>
            <svg width="200px" height="200px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
                <g>
                    <animateTransform attributeName="transform" type="rotate" values="360 50 50;0 50 50" keyTimes="0;1" dur="2.083333333333333s" repeatCount="indefinite" calcMode="spline" keySplines="0.5 0 0.5 1" begin="-0.5208333333333333s"></animateTransform>
                    <circle cx="50" cy="50" r="39.891" stroke="#6994b7" strokeWidth="14.4" fill="none" strokeDasharray="0 300">
                        <animate attributeName="stroke-dasharray" values="15 300;137.8533997987855 300;15 300" keyTimes="0;0.5;1" dur="2.083333333333333s" repeatCount="indefinite" calcMode="linear" keySplines="0 0.4 0.6 1;0.4 0 1 0.6" begin="-0.2395833333333333s"></animate>
                    </circle>
                    ...
                    <circle cx="50" cy="50" r="32.771" stroke="#000000" strokeWidth="1" fill="none" strokeDasharray="0 300">
                        <animate attributeName="stroke-dasharray" values="15 300;113.24844613587022 300;15 300" keyTimes="0;0.5;1" dur="2.083333333333333s" repeatCount="indefinite" calcMode="linear" keySplines="0 0.4 0.6 1;0.4 0 1 0.6" begin="-0.2395833333333333s"></animate>
                    </circle>
                    <circle cx="50" cy="50" r="47.171" stroke="#000000" strokeWidth="1" fill="none" strokeDasharray="0 300">
                        <animate attributeName="stroke-dasharray" values="15 300;165.08472492010182 300;15 300" keyTimes="0;0.5;1" dur="2.083333333333333s" repeatCount="indefinite" calcMode="linear" keySplines="0 0.4 0.6 1;0.4 0 1 0.6" begin="-0.2395833333333333s"></animate>
                    </circle>
                </g>

                <g>
                    <animateTransform attributeName="transform" type="rotate" values="360 50 50;0 50 50" keyTimes="0;1" dur="2.083333333333333s" repeatCount="indefinite" calcMode="spline" keySplines="0.5 0 0.5 1"></animateTransform>
